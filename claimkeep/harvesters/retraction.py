...
RETRACT_RU_RX = re.compile(
    r"(?i)(ошиб(?:лась|ся|ка|ки)|неверно|опроверг|поправк|на самом деле|снимаю|"
    r"отмен(?:яю|ено)|ты прав|была не права|оказалось не)"
)
...
_STOP = {
    "that", "this", "with", "from", "have", "been", "what", "when", "which",
    "there", "their", "would", "could", "should", "about", "after", "before",
    "быть", "было", "этот", "этом", "того", "тоже", "чтобы", "потому", "когда",
}
